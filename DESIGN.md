...
- Every title's visible glyph block remains centred at the inner viewport's 50%/50%, including the opening and ending. Titles do not bank or translate during their lifecycle. Support and contact actions sit in their own area below. Full prose uses Geist in the central reading column. Original palette colours and gradients stay unmodified. Smaller circles and physical gaps preserve reading space.
