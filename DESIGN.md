...
- Native scrolling owns camera progress. Measured copy can extend its reading budget without shortening either tunnel. A short, critically damped glide smooths camera travel and settles on the native scroll position. Reversing scroll retraces the rail without overshoot; restored history and reduced motion bypass inertia. Independent, pause-aware ambient time drives the moving assemblies and final wall.
- Every title's visible glyph block remains centred at the inner viewport's 50%/50%, including the opening and ending. Titles use Home’s shared per-letter colour reveal on every new visit. A 1600px perspective carries them gently from 100px behind the reading plane to 70px in front; they do not bank or move horizontally or vertically. Opening and ending titles ease into the reading plane over 900ms. Reduced Motion settles all letters immediately and removes title depth. Support and contact actions sit in their own area below. Full prose uses Geist in the central reading column. Original palette colours and gradients stay unmodified. Smaller circles and physical gaps preserve reading space.
