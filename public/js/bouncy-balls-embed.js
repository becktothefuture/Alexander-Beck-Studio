/* Alexander Beck Studio – Bouncy Balls | Build: 2025-12-13T02:29:14.755Z */
var BouncyBalls = (function (exports) {
  ...
  function playCollisionSound(ballRadius, intensity, xPosition = 0.5, ballId = null) {
    ...
    if (!isEnabled$2 || !isUnlocked || !audioContext) return;
  ...
  function applyToneSafety(frequency, gain, filterFreq) {
    ...
    const brightMul = clamp$1(1 - CONFIG.toneSafetyHighBrightAtten * high, 0.55, 1);
    let safeFilter = filterFreq * brightMul;

    // Clamp into safe filter range
    safeFilter = clamp$1(safeFilter, CONFIG.filterMinHz, CONFIG.filterMaxHz);
