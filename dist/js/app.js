...
import { i as isDev, r as resetCurrentMode, N as NARRATIVE_MODE_SEQUENCE, s as setMode, g as getGlobals, M as MODES, p as playCollisionSound, l as loadRuntimeText, a as applyRuntimeTextToDOM, b as group, m as mark, c as log, d as loadRuntimeConfig, e as initState, f as applyLayoutCSSVars, h as initNoiseSystem, j as setupRenderer, k as getCanvas, n as setCanvas, o as resize, q as setupPointer, t as setupCustomCursor, u as initLinkCursorHop, v as initSceneImpactReact, w as loadSettings, x as rotatePaletteChapterOnReload, y as initSoundEngine, z as applySoundConfigFromRuntimeConfig, A as initializeDarkMode, B as initModalOverlay, C as initCVModal, D as initPortfolioModal, E as initContactModal, F as upgradeSocialIcons, G as initTimeDisplay, H as createSoundToggle, I as maybeAutoPickCursorColor, J as startMainLoop, K as measure, L as table, O as groupEnd, P as printConsoleBanner, Q as initConsolePolicy, R as waitForFonts, S as getContext, T as getText, U as setForceRenderCallback, V as render, W as getForceApplicator } from './shared.js';
import { u as updateModeButtonsUI } from './controls.js';
...
(async function init() {
  ...
  {
    try {
      const mod = await import('./controls.js').then(function (n) { return n.h; });
  ...
  try {
    ...
    // Production builds must ship without the panel (config is hardcoded during build).
    {
      try {
        ...
        const colors = await import('./shared.js').then(function (n) { return n.aG; });
    ...
    setMode(startMode);
    try {
      const ui = await import('./controls.js').then(function (n) { return n.i; });
    ...
    try {
      const { orchestrateEntrance, revealAllLateElements } = await import('./shared.js').then(function (n) { return n.aP; });
      const { 
        getModalToAutoOpen, 
        shouldSkipWallAnimation, 
        resetTransitionState,
        setupPrefetchOnHover 
      } = await import('./shared.js').then(function (n) { return n.aO; });
      ...
      try {
        const { revealAllLateElements } = await import('./shared.js').then(function (n) { return n.aP; });
        revealAllLateElements();
      } catch (err) {
