...
(async function init() {
  ...
  {
    try {
      const mod = await import('./shared.js').then(function (n) { return n.aL; });
  ...
  try {
    ...
    // Production builds must ship without the panel (config is hardcoded during build).
    {
      try {
        ...
        const colors = await import('./shared.js').then(function (n) { return n.aJ; });
    ...
    try {
      const { orchestrateEntrance, revealAllLateElements } = await import('./shared.js').then(function (n) { return n.aN; });
      const { 
        getModalToAutoOpen, 
      ...
      } = await import('./shared.js').then(function (n) { return n.aM; });
      ...
      try {
        const { revealAllLateElements } = await import('./shared.js').then(function (n) { return n.aN; });
        revealAllLateElements();
      } catch (err) {
