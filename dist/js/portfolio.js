...
import { l as loadRuntimeText, c as applyRuntimeTextToDOM, T as waitForFonts, g as getGlobals, f as loadRuntimeConfig, Z as applyWallFrameFromConfig, A as initSoundEngine, B as applySoundConfigFromRuntimeConfig, k as initNoiseSystem, _ as applyWallFrameLayout, $ as initSharedChrome, z as rotatePaletteChapterOnReload, C as initializeDarkMode, a0 as syncWallFrameColors, K as maybeAutoPickCursorColor, I as initTimeDisplay, H as upgradeSocialIcons, a1 as navigateWithTransition, a2 as NAV_STATES, a3 as resetTransitionState, a4 as setupPrefetchOnHover, a5 as updateWheelSfxConfig, J as createSoundToggle, a6 as playWheelSnap, a7 as playWheelCenterClick, a8 as playWheelOpen, a9 as playWheelClose, aa as updateWheelSfx } from './shared.js';
...
async function bootstrapPortfolio() {
  ...
  try {
    ...
    const { didViewTransitionRun } = await import('./shared.js').then(function (n) { return n.aM; });
    ...
    if (viewTransitionHandled) {
      ...
      const { orchestrateEntrance } = await import('./shared.js').then(function (n) { return n.aN; });
