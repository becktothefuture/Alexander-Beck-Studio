...
import { l as loadRuntimeText, c as applyRuntimeTextToDOM, T as waitForFonts, g as getGlobals, f as loadRuntimeConfig, _ as applyWallFrameFromConfig, A as initSoundEngine, B as applySoundConfigFromRuntimeConfig, k as initNoiseSystem, $ as applyWallFrameLayout, a0 as initSharedChrome, z as rotatePaletteChapterOnReload, C as initializeDarkMode, a1 as syncWallFrameColors, K as maybeAutoPickCursorColor, I as initTimeDisplay, H as upgradeSocialIcons, a2 as navigateWithTransition, a3 as NAV_STATES, a4 as resetTransitionState, a5 as setupPrefetchOnHover, a6 as updateWheelSfxConfig, J as createSoundToggle, a7 as playWheelSnap, a8 as playWheelCenterClick, a9 as playWheelOpen, aa as playWheelClose, ab as updateWheelSfx } from './shared.js';
...
function normalizePortfolioRuntime(runtime = {}) {
...
function applyPortfolioConfig(config) {
...
class PortfolioApp {
  ...
  applyWheelImpulse(delta) {
    ...
    const ratio = delta / viewportSize ;
...
async function bootstrapPortfolio() {
  ...
  try {
    ...
    const { didViewTransitionRun } = await import('./shared.js').then(function (n) { return n.aN; });
    ...
    if (viewTransitionHandled) {
      ...
      const { orchestrateEntrance } = await import('./shared.js').then(function (n) { return n.aO; });
  ...
  try {
    ...
    initSoundEngine();
    applySoundConfigFromRuntimeConfig(runtimeConfig);
  ...
  {
    try {
      const { createPanelDock } = await import('./panel-dock.js');
      const { generatePanelSectionsHTML } = await import('./control-registry.js');
      const { setupControls } = await import('./controls2.js');
      const { setupBuildControls } = await import('./build-controls.js');
