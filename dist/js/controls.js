...
function applyParallaxLinearPreset(presetName, reinit = true) {
  ...
  if (reinit) {
    import('./shared.js').then(function (n) { return n.aI; }).then(({ resetCurrentMode }) => resetCurrentMode());
  }
    ...
    controls: [
      {
        ...
        isHero: true,
        onChange: (g) => {
          import('./shared.js').then(function (n) { return n.aI; }).then(({ setMode }) => {
    ...
    controls: [
      {
        ...
        onChange: (g) => {
          import('./shared.js').then(function (n) { return n.aM; }).then(({ getCurrentTheme, setTheme }) => {
    ...
    controls: [
      {
        ...
        onChange: (g, val) => {
          ...
          import('./shared.js').then(function (n) { return n.aF; }).then(({ updateBallSizes }) => {
            updateBallSizes();
          ...
          import('./shared.js').then(function (n) { return n.aK; }).then(({ updateCursorSize }) => {
            updateCursorSize();
          });
        }
      },
  ...
  uiSpacing: {
    ...
    controls: [
      { type: 'divider', label: 'Content' },
       {
         ...
         onChange: (g, val) => {
           ...
           import('./shared.js').then(function (n) { return n.aF; }).then(({ applyLayoutFromVwToPx, applyLayoutCSSVars }) => {
           ...
           import('./shared.js').then(function (n) { return n.aH; }).then(({ resize }) => { try { resize(); } catch (e) {} }).catch(() => {});
         }
       },
       {
      ...
      },
      {
        ...
        onChange: () => {
          import('./shared.js').then(function (n) { return n.aF; }).then(mod => {
  ...
  overlay: {
    ...
    controls: [
      ...
      },
      {
        ...
        parse: parseFloat,
        onChange: (g, val) => {
          import('./shared.js').then(function (n) { return n.aJ; }).then(({ updateOverlayOpacity }) => {
      ...
      },
      {
        ...
        onChange: (g, val) => {
          import('./shared.js').then(function (n) { return n.aJ; }).then(({ updateOverlayBlur }) => {
      ...
      },
      {
        ...
        onChange: (g, val) => {
          import('./shared.js').then(function (n) { return n.aJ; }).then(({ updateOverlayTransition }) => {
      ...
      },
      {
        ...
        onChange: (g, val) => {
          import('./shared.js').then(function (n) { return n.aJ; }).then(({ updateOverlayTransitionOut }) => {
      ...
      },
      {
        ...
        onChange: (g, val) => {
          import('./shared.js').then(function (n) { return n.aJ; }).then(({ updateGateContentDelay }) => {
      ...
      },
      {
        ...
        onChange: (g, val) => {
          import('./shared.js').then(function (n) { return n.aJ; }).then(({ updateGateDepthScale }) => {
      ...
      },
      {
        ...
        onChange: (g, val) => {
          import('./shared.js').then(function (n) { return n.aJ; }).then(({ updateGateDepthTranslateY }) => {
      ...
      },
      {
        ...
        onChange: (g, val) => {
          import('./shared.js').then(function (n) { return n.aJ; }).then(({ updateLogoBlurInactive }) => {
      ...
      },
      {
        ...
        onChange: (g, val) => {
          import('./shared.js').then(function (n) { return n.aJ; }).then(({ updateLogoBlurActive }) => {
    ...
    controls: [
      {
        ...
        onChange: (g, val) => {
          ...
          import('./shared.js').then(function (n) { return n.aL; }).then(mod => {
            mod.syncChromeColor();
          });
        }
      },
      ...
      },
      {
        ...
        onChange: (g, val) => {
          import('./shared.js').then(function (n) { return n.aF; }).then(mod => {
            ...
            import('./shared.js').then(function (n) { return n.aJ; }).then(({ updateBlurFromWallThickness }) => {
    ...
    controls: [
      ...
      },
      {
        ...
        onChange: (g) => {
          ...
          import('./shared.js').then(function (n) { return n.aF; }).then(({ applyLayoutFromVwToPx }) => {
            applyLayoutFromVwToPx();
          }).catch(() => {});
        }
      }
  ...
  entrance: {
    ...
    controls: [
      ...
      },
      {
        ...
        onChange: () => {
          import('./shared.js').then(function (n) { return n.aP; }).then(({ applyPerspectiveCSS }) => {
            applyPerspectiveCSS();
          }).catch(() => {});
        }
      },
    ...
    for (const control of section.controls) {
      ...
      if (control.type === 'colorDistribution') {
        ...
        function applyDistributionSideEffects() {
          ...
          import('./shared.js').then(function (n) { return n.aG; })
      ...
      if (control.type === 'checkbox' || control.type === 'toggle') {
        ...
        el.addEventListener('change', () => {
          ...
          if (control.reinitMode && g.currentMode === section.mode) {
            import('./shared.js').then(function (n) { return n.aI; })
...
export { generatePanelHTML as a, getAllControls as b, setupMasterControls as c, generateThemeSectionHTML as d, generateMasterSectionsHTML as e, generateColorTemplateSectionHTML as f, generateHomePanelHTML as g, controlRegistry as h, controls as i, setupIndexControls as s, updateModeButtonsUI as u };
