      ...
      window.__ABS_HOME_AUDIT__ = {
        ...
        getRuntimeSnapshot: () => {
          ...
          return {
            ...
            canvasTitleBloomActive: canvasTitleState.bloomActive === true,
            canvasTitleBloomAffectedGlyphCount: Number(canvasTitleState.bloomAffectedGlyphCount) || 0,
            canvasTitleBloomRadiusCssPx: Number(canvasTitleState.bloomRadiusCssPx) || 0,
            canvasTitleBloomMaxRenderedScale: Number(canvasTitleState.bloomMaxRenderedScale) || 1,
            canvasTitleBloomMaxTargetScale: Number(canvasTitleState.bloomMaxTargetScale) || 1,
            canvasTitleBloomSettled: canvasTitleState.bloomSettled !== false,
            canvasTitleSleeping: canvasTitleState.sleeping === true,
