...
import { applyColorTemplate, getPaletteTemplateOverrideFromUrl, getWeatherDrivenPaletteTemplate } from './modules/visual/colors.js';
...
async function initSplatTest() {
  ...
  setupPointer();
  applyColorTemplate(getPaletteTemplateOverrideFromUrl() || getWeatherDrivenPaletteTemplate() || 'riverMist');
