...
// - Ball Field opens the story (source material)
...
export const NARRATIVE_CHAPTER_TITLES = {
  [MODES.PIT]: 'BALL FIELD',
  [MODES.FLIES]: 'LIGHT SWARM',
  [MODES.BUBBLES]: 'BUBBLE LIFT',
  [MODES.MAGNETIC]: 'MAGNETIC FIELD',
  [MODES.WATER]: 'WATER FLOW',
  ...
  [MODES.NAPOLEON_POINT_CLOUD]: 'BUST CLOUD',
