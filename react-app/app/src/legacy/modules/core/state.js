...
const state = {
  ...
  mouseInCanvas: false,
  pointerX: CONSTANTS.OFFSCREEN_MOUSE,
  pointerY: CONSTANTS.OFFSCREEN_MOUSE,
  pointerInCanvas: false,
  pointerActive: false,
  pointerType: 'mouse',
  pointerInputId: null,
  pointerSequence: 0,
  pointerLastEventMs: 0,
  pointerLastDownMs: 0,
  pointerLastMoveMs: 0,
  pointerJustEnteredCanvas: false,
  lastPointerMoveMs: 0,
  ...
  brandLogoSecondaryOpacity: 0.36,    // Shared role-line tone (canvas + DOM)
