export const PORTFOLIO_DOM_CONTRACT = Object.freeze({
  ...
  state: Object.freeze({
    ...
    carouselInputState: 'data-carousel-input-state',
    inputReleaseState: 'data-portfolio-input-release-state',
    inputReleaseReason: 'data-portfolio-input-release-reason',
