  ...
  carousel: {
    ...
    groups: [
      ...
      },
      {
        ...
        controls: [
          {
            id: 'carouselCompositionYOffsetDvh',
            label: 'Composition Y',
            configKey: 'runtime.carousel.compositionYOffsetDvh',
            type: 'range',
            min: -12,
            max: 12,
            step: 0.25,
            ...
            default: -1.5,
            refresh: true,
            hint: 'Moves the vertically centred Work title and carousel together without changing their spacing.',
          },
