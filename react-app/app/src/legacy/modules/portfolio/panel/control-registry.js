    ...
    groups: [
      ...
      },
      {
        ...
        controls: [
          ...
          { id: 'carouselMobileAngleStepDeg', label: 'Minimum mobile spacing', configKey: 'runtime.carousel.mobileAngleStepDeg', type: 'range', min: 7, max: 24, step: 0.25, unit: 'deg', default: 13.5, refresh: true, hint: 'Minimum angle between cards on mobile. The collision guard may use a larger effective angle.' },
