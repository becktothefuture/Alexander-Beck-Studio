    ...
    groups: [
      {
        ...
        title: 'Card Size',
        controls: [
          { id: 'carouselCardMinWidthPx', label: 'Minimum width', configKey: 'runtime.carousel.cardMinWidthPx', type: 'range', min: 180, max: 320, step: 2, unit: 'px', default: 220, refresh: true },
          { id: 'carouselCardMaxWidthPx', label: 'Maximum width', configKey: 'runtime.carousel.cardMaxWidthPx', type: 'range', min: 320, max: 560, step: 2, unit: 'px', default: 420, refresh: true },
        ],
      },
      {
        key: 'track-layout',
        ...
        controls: [
          ...
          { id: 'carouselCenterYPercent', label: 'Track Y', configKey: 'runtime.carousel.centerYPercent', type: 'range', min: 45, max: 74, step: 0.25, unit: '%', default: 50, refresh: true },
          { id: 'carouselMobileCenterYPercent', label: 'Mobile track Y', configKey: 'runtime.carousel.mobileCenterYPercent', type: 'range', min: 48, max: 72, step: 0.25, unit: '%', default: 58, refresh: true },
      ...
      },
      {
        ...
        title: 'Line Track',
        controls: [
          { id: 'carouselIndicatorGapPx', label: 'Line spacing', configKey: 'runtime.carousel.indicatorGapPx', type: 'range', min: 5, max: 24, step: 1, unit: 'px', default: 9, refresh: true, hint: 'Edge-to-edge spacing between the straight indicator marks.' },
          { id: 'carouselDotDensity', label: 'Line count', configKey: 'runtime.carousel.dotDensity', type: 'range', min: 5, max: 48, step: 1, unit: '', default: 18, refresh: true, hint: 'Total lines in the repeating track. The production value matches the shared progress instrument.' },
          { id: 'carouselDotParallaxRatio', label: 'Scroll ratio', configKey: 'runtime.carousel.dotParallaxRatio', type: 'range', min: -2, max: 2, step: 0.05, unit: '', default: 1, refresh: true, hint: 'How far and in which direction the active pair advances while the carousel moves.' },
        ],
      },
      {
        key: 'gesture-input',
      ...
      },
      {
        ...
        controls: [
          ...
          { id: 'carouselParticleInertia', label: 'Motion inertia', configKey: 'runtime.carousel.particleField.inertiaMs', type: 'range', min: 80, max: 700, step: 10, unit: 'ms', default: 260, refresh: true, hint: 'How long particle movement coasts after carousel input stops.' },
