const CONTROL_SECTIONS = {
  ...
  bodies: {
    ...
    controls: [
      ...
      {
        id: 'squircleLameExponent',
        label: 'Squircle exponent',
        configKey: 'runtime.bodies.squircleLameExponent',
        type: 'range',
        min: 2.5,
        max: 8,
        step: 0.05,
        ...
        default: 4,
        refresh: true,
        hint: 'Lamé superellipse n in |x/a|^n+|y/b|^n = 1 (square squircle bodies). 4 ≈ app-style icon; same curve for fill + collision.',
      },
    ],
  },
  labeling: {
