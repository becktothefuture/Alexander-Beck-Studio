...
const RETIRED_RUNTIME_KEYS = new Set([
  ...
  'buttonBarWidthPx',
  'buttonBarMaxWidthPx',
  'buttonBarButtonBgWindowMixPct',
  'buttonBarButtonBgWhiteMixPct',
  'buttonBarButtonHoverWhiteMixPct',
  'buttonBarButtonActiveWindowMixPct',
  'buttonBarButtonActiveWhiteMixPct',
  'buttonBarIndicatorOpacity',
  'buttonBarShadowOpacity',
  'buttonBarGrooveLightOpacity',
  ...
  'shellTabHoverWhiteMixPct',
  'shellTabActiveWallMixPct',
  'shellTabActiveWhiteMixPct',
  'shellTabIndicatorOpacity',
  'shellTabShadowOpacity',
  'shellTabGrooveLightOpacity',
  'shellTabActiveGlowPx',
  'shellTabActiveDropPx',
...
const SHELL_ROUTE_TRANSITION_NUMBER_KEYS = Object.freeze([
  ...
  'routeBookendDescriptionLineStaggerMs', 'routeBookendTravelPercent',
  'contextDurationMs',
  'actionDurationMs',
  'supportDurationMs',
  'itemStepMs',
