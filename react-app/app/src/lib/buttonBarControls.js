...
export const BUTTON_BAR_CONTROL_GROUPS = Object.freeze([
  { title: 'Tactile navigation', initiallyOpen: true, controls: [
    ...
    control('RowPaddingInlinePx', 'Desktop horizontal padding', 46, 16, 80, 0.5),
    control('MobileRowPaddingInlinePx', 'Mobile horizontal padding', 28, 12, 60, 0.5),
    ...
    control('PressedDepth', 'Pressed depth (shading)', 1.5, 0, 2, 0.05, ''),
    control('PopStrength', 'Shading rebound', 0.05, 0, 0.15, 0.01, ''),
  ...
  { title: 'Pressed light and shadow', initiallyOpen: false, controls: [
    ...
    control('LowerShadowStrength', 'Lower shadow strength', 0.18, 0, 0.8, 0.01, ''),
