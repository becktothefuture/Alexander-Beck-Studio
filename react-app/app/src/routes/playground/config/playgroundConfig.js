...
export const PLAYGROUND_CONFIG_BOUNDS = Object.freeze({
  ...
  itemScale: Object.freeze({ min: 0.75, max: 1.35, step: 0.01 }),
  ...
  colorWakePersistenceMs: Object.freeze({ min: 300, max: 3000, step: 100, integer: true }),
