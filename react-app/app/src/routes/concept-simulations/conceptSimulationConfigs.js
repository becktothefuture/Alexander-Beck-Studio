...
export const CONCEPT_SIMULATION_REGISTRY = Object.freeze({
  ...
  [CONCEPT_SIMULATION_IDS.RIFT_RINGS]: {
    ...
    defaults: {
      ...
      driftSpeed: 0.42,
      shearStrength: 0.72,
      expansionStrength: 0.82,
      idleMotion: 0.46,
      pointerStrength: 0.9,
      centerRadiusScale: 0.52,
      mobileCenterRadiusScale: 0.55,
      centerFogMin: 0.24,
      centerFogStart: 0.74,
      centerFogRingCount: 2,
      mobileCenterFogMin: 0.36,
...
export function normalizeConceptSimulationConfig(simulationId, input = {}) {
  ...
  if (simulationId === CONCEPT_SIMULATION_IDS.RIFT_RINGS) {
    ...
    next.outerRadiusScale = clampNumber(next.outerRadiusScale, 0.9, 1.95, defaults.outerRadiusScale);
