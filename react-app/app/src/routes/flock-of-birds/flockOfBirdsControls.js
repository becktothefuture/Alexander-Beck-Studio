export const DEFAULT_FLOCK_OF_BIRDS_CONFIG = {
  ...
  mobileHorizontalOverscan: 0.05,
  mobileVerticalSpreadScale: 1.35,
  mobileSpacingScale: 1.35,
  mobileCourseStrength: 0.42,
  mobileStrayRecovery: 0.72,
  mobileCruiseSpeed: 150,
  birdRadius: 10.4,
  depthSize: 0.02,
  neighborRadius: 148,
  separationRadius: 32,
...
export const FLOCK_OF_BIRDS_CONFIG_CONTROLS = [
  ...
  { id: 'mobileHorizontalOverscan', type: 'range', min: 0, max: 0.5, step: 0.01 },
  { id: 'mobileVerticalSpreadScale', type: 'range', min: 0.75, max: 2, step: 0.01 },
  { id: 'mobileSpacingScale', type: 'range', min: 0.75, max: 1.75, step: 0.01 },
  { id: 'mobileCourseStrength', type: 'range', min: 0, max: 1.8, step: 0.01 },
  { id: 'mobileStrayRecovery', type: 'range', min: 0, max: 2.2, step: 0.01 },
  { id: 'mobileCruiseSpeed', type: 'range', min: 24, max: 230, step: 1 },
