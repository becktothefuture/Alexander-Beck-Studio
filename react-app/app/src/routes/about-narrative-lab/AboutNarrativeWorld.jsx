...
function ThreePointWorld({ rootRef, interactionRef, disciplineOverlayRef, runtimeRef, pointProfile }) {
  return (
    <div className="about-narrative-world" data-world-implementation={DEFAULT_ABOUT_NARRATIVE_WORLD} aria-hidden="true">
      <AboutNarrativePointWorld3D rootRef={rootRef} interactionRef={interactionRef} disciplineOverlayRef={disciplineOverlayRef} runtimeRef={runtimeRef} pointProfile={pointProfile} />
    </div>
  );
}
...
export function AboutNarrativeWorld({
  ...
  return <Renderer rootRef={rootRef} interactionRef={interactionRef} disciplineOverlayRef={disciplineOverlayRef} runtimeRef={runtimeRef} pointProfile={pointProfile} />;
}
