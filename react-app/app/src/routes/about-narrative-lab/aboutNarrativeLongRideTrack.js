...
// Measured narrow, short and enlarged-type layouts need their complete reading
// distance plus the river passage. Keep one finite shared cap for validation.
export const ABOUT_NARRATIVE_LONG_RIDE_MAX_DURATION_WU = 384;
