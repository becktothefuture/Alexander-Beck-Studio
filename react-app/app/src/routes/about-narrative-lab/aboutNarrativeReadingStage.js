...
export function writeAboutNarrativeReadingStage(target, fieldTopPx, fieldHeightPx, viewportHeight, stage = ABOUT_READING_STAGE) {
  ...
  const end = height * stage.bottom - top;
