...
export const ABOUT_NARRATIVE_REQUIRED_EVIDENCE = Object.freeze([
  ...
  Object.freeze({ id: 'visual-desktop-discipline', path: 'output/playwright/about-narrative-hardening/runtime/desktop-discipline.png', reviewRequired: true }),
  Object.freeze({ id: 'visual-mobile-discipline', path: 'output/playwright/about-narrative-hardening/runtime/mobile-discipline.png', reviewRequired: true }),
  ...
  Object.freeze({ id: 'visual-desktop-bust', path: 'output/playwright/about-narrative-hardening/runtime/desktop-bust.png', reviewRequired: true }),
  Object.freeze({ id: 'certification-chromium-desktop', path: 'output/playwright/about-narrative/chromium-desktop.png' }),
  Object.freeze({ id: 'certification-chromium-mobile', path: 'output/playwright/about-narrative/chromium-mobile.png' }),
  Object.freeze({ id: 'certification-webkit-desktop', path: 'output/playwright/about-narrative/webkit-desktop.png' }),
  Object.freeze({ id: 'certification-webkit-mobile', path: 'output/playwright/about-narrative/webkit-mobile.png' }),
  Object.freeze({ id: 'production-chromium-desktop', path: 'output/playwright/about-narrative/chromium-production-desktop.png' }),
  Object.freeze({ id: 'production-chromium-mobile', path: 'output/playwright/about-narrative/chromium-production-mobile.png' }),
  Object.freeze({ id: 'production-webkit-desktop', path: 'output/playwright/about-narrative/webkit-production-desktop.png' }),
  Object.freeze({ id: 'production-webkit-mobile', path: 'output/playwright/about-narrative/webkit-production-mobile.png' }),
