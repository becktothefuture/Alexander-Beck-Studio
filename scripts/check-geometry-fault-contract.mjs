...
function createShellGeometryHarness() {
  ...
  const routeTransition = {
    ...
    routeBookendDurationMs: 10,
    routeBookendOverlapPercent: 11,
    routeBookendLineDurationMs: 12,
    routeBookendTravelPercent: 13,
    contextDurationMs: 14,
    actionDurationMs: 15,
    supportDurationMs: 16,
    itemStepMs: 17,
    repeatTimingScale: 0.8,
    repeatStaggerScale: 0.7,
  };
  const config = {
    layout: {
