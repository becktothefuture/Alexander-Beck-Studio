...
| About Me | `routes/about/AboutRoute.jsx` | React-owned Three.js point world; scene parameters loaded only in development |
...
- `contents-about.json`: canonical content and choreography for production About playback and the development scene parameter panel
...
4. verify that About playback is present while the development-only scene parameter panel and Save client did not enter production assets.
