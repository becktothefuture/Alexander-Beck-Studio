...
The active prose source is `../ABOUT-NARRATIVE-SCRIPT-v15.md`, which includes the current visual allocation. Interviews, source material and tone guidance remain in `../supporting/`.
...
These files contain useful ideas and phrases, but their architecture and copy predate the active V15 prose.
