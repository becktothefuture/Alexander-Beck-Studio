...
The active prose source is `../ABOUT-NARRATIVE-SCRIPT-v24.md`. Visual allocation is documented separately in the current rhythm storyboard and implementation files. Interviews, source material and tone guidance remain in `../supporting/`.
