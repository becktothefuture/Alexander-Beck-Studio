...
**A clear point of view, stated plainly, then earned through evidence.**
...
Short statements can be spatial and emphatic. Prose should remain natural and conversational. Use repetition only when the animation gives it a reason.
...
- **Method → human result:** “Prototypes reveal how an interaction responds and how a brand feels in use.”
