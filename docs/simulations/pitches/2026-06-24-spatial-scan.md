...
- Why it differs: Impression is object-specific and iconic; Spatial Scan tests whether scanned spatial data can become a reusable site material without losing the circle language.
