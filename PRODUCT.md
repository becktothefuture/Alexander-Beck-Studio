...
The current build and preview boundaries are documented in [README.md](README.md#routes). Work shows Coming soon in production. About publishes its complete spatial journey; its authoring controls remain local to development. A development experience or an intentional preview is not proof of public release.
